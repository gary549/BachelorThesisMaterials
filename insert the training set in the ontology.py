...
with open("D://thesis relevant WD//reactioninfo-training set.yaml") as file2:
...
g = Graph()
g.parse("D://thesis relevant WD//reaction ontology2 - Copy.owl")
...
for item in my_list:
    ...
    g.add((sub_class, RDFS.label, Literal(item.Experiment_number)))
...
g.serialize(destination='updated_reaction ontology.owl', format='xml')
